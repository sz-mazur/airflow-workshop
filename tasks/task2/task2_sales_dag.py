...
with DAG(
    ...
    mean_revenue = PythonOperator(
        ...
        op_kwargs={"separator": ",", "group_function": "mean", "file_path": DATA_FILE_PATH},
    )
    # Second Operator
    max_revenue = PythonOperator(
        task_id="max_revenue",
        python_callable=calculate_revenue,
        op_kwargs={"separator": ",", "group_function": "max", "file_path": DATA_FILE_PATH},
    )
    ...
    diff_revenue = PythonOperator(
        ...
        op_kwargs={"mean_revenue_path": MEAN_FILE_PATH, "max_revenue_path": MAX_FILE_PATH},
    )
    ...
    # Dependencies
    waiting_for_data >> mean_revenue
    waiting_for_data >> max_revenue

    mean_revenue >> diff_revenue
    max_revenue >> diff_revenue

    diff_revenue >> delete_source_file
    diff_revenue >> workflow_finished_operator
